...
class GeminiClient(
    ...
    private fun buildSummaryPrompt(content: String): String =
        ...
        - summary: 콘텐츠의 주요 내용을 2-3문장으로 간결하게 요약 (한글로)
        ...
        - "넷플릭스가 쓰는 극비 아키텍처 공개"
        - "ChatGPT보다 100배 빠른 방법"

        형식: {"summary":"핵심내용요약","provocativeHeadlines":["실리콘밸리 개발자들이 숨기는 비밀","이 코드 한 줄로 연봉이 2배 올랐다","구글이 절대 알려주지 않는 최적화 기법"]}
        """.trimIndent()
