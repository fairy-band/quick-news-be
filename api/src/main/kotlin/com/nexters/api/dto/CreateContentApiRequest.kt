...
data class CreateContentApiRequest(
    ...
    val content: String,
    @Schema(description = "뉴스레터 이름", example = "Kotlin Weekly")
    val newsletterName: String,
    @Schema(description = "원본 URL", example = "https://example.com/article")
    val originalUrl: String,
    @Schema(description = "발행 날짜", example = "2024-03-21")
    val publishedAt: LocalDate,
    @Schema(description = "뉴스레터 소스 ID", example = "source-123", required = false)
    val newsletterSourceId: String? = null,
    @Schema(description = "콘텐츠 제공자 이름", example = "Kotlin Weekly", required = false)
